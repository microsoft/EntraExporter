@{
    ...
    NestedModules = @(
        ...
        'Get-AADExportUserFlowB2CUserAttributeAssignments.ps1'
        'Get-AADExportUserFlowB2CLanguages.ps1'
        'Get-AADExportUserFlowB2CAPIConnectors.ps1'
        'Get-AADExportUserFlowb2xUserAttributeAssignments.ps1'
        'Get-AADExportUserFlowb2xLanguages.ps1'
        'Get-AADExportUserFlowb2xAPIConnectors.ps1'
    ...
    FunctionsToExport = @(
        ...
        'Get-AADExportUserFlowb2xAPIConnectors'
